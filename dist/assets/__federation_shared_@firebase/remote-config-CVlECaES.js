...
import { g as getModularInstance, C as Component, t as isIndexedDBAvailable, v as validateIndexedDBOpenable, E as ErrorFactory, F as FirebaseError, u as calculateBackoffMillis } from "../index.esm2017-VG2SW2cC.js";
import { a as LogLevel, L as Logger } from "../index.esm2017-BVSbM8hR.js";
import "../index.esm2017-CZyS-7PE.js";
const { _getProvider, getApp, _registerComponent, registerVersion, SDK_VERSION } = await importShared("@firebase/app");
 ...
 * limitations under the License.
 */
const DEFAULT_FETCH_TIMEOUT_MILLIS = 60 * 1e3;
const DEFAULT_CACHE_MAX_AGE_MILLIS = 12 * 60 * 60 * 1e3;
class RemoteConfig {
